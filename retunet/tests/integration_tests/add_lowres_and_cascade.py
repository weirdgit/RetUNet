...
if __name__ == '__main__':
    ...
    for d in args.d:
        ...
        plans = load_json(join(RetUNet_preprocessed, dataset_name, 'nnUNetPlans.json'))
        ...
        save_json(plans, join(RetUNet_preprocessed, dataset_name, 'nnUNetPlans.json'), sort_keys=False)