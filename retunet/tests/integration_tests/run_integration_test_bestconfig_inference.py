...
from retunet.ensembling.ensemble import ensemble_folders
from retunet.evaluation.find_best_configuration import find_best_configuration, \
    dumb_trainer_config_plans_to_trained_models_dict
from retunet.inference.predict_from_raw_data import nnUNetPredictor
from retunet.paths import RetUNet_raw, RetUNet_results
from retunet.postprocessing.remove_connected_components import apply_postprocessing_to_folder
from retunet.utilities.dataset_name_id_conversion import maybe_convert_to_dataset_name
from retunet.utilities.file_path_utilities import get_output_folder
...
if __name__ == '__main__':
    ...
    source_dir = join(RetUNet_raw, dataset_name, 'imagesTs')
    target_dir_base = join(RetUNet_results, dataset_name)
