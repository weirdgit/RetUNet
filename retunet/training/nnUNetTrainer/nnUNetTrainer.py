...
from retunet.configuration import ANISO_THRESHOLD, default_num_processes
from retunet.evaluation.evaluate_predictions import compute_metrics_on_folder
from retunet.inference.export_prediction import export_prediction_from_logits, resample_and_save
from retunet.inference.predict_from_raw_data import nnUNetPredictor
from retunet.inference.sliding_window_prediction import compute_gaussian
from retunet.paths import RetUNet_preprocessed, RetUNet_results
from retunet.training.data_augmentation.compute_initial_patch_size import get_patch_size
from retunet.training.data_augmentation.custom_transforms.cascade_transforms import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, RemoveRandomConnectedComponentFromOneHotEncodingTransform
from retunet.training.data_augmentation.custom_transforms.deep_supervision_donwsampling import \
    DownsampleSegForDSTransform2
from retunet.training.data_augmentation.custom_transforms.limited_length_multithreaded_augmenter import \
    LimitedLenWrapper
from retunet.training.data_augmentation.custom_transforms.masking import MaskTransform
from retunet.training.data_augmentation.custom_transforms.region_based_training import \
    ConvertSegmentationToRegionsTransform
from retunet.training.data_augmentation.custom_transforms.transforms_for_dummy_2d import Convert2DTo3DTransform, \
    Convert3DTo2DTransform
from retunet.training.dataloading.data_loader_2d import nnUNetDataLoader2D
from retunet.training.dataloading.data_loader_3d import nnUNetDataLoader3D
from retunet.training.dataloading.nnunet_dataset import nnUNetDataset
from retunet.training.dataloading.utils import get_case_identifiers, unpack_dataset
from retunet.training.logging.nnunet_logger import nnUNetLogger
from retunet.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from retunet.training.loss.deep_supervision import DeepSupervisionWrapper
from retunet.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from retunet.training.lr_scheduler.polylr import PolyLRScheduler
from retunet.utilities.collate_outputs import collate_outputs
from retunet.utilities.crossval_split import generate_crossval_split
from retunet.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from retunet.utilities.file_path_utilities import check_workers_alive_and_busy
from retunet.utilities.get_network_from_plans import get_network_from_plans
from retunet.utilities.helpers import empty_cache, dummy_context
from retunet.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from retunet.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.preprocessed_dataset_folder_base = join(RetUNet_preprocessed, self.plans_manager.dataset_name) \
            if RetUNet_preprocessed is not None else None
        self.output_folder_base = join(RetUNet_results, self.plans_manager.dataset_name,
                                       self.__class__.__name__ + '__' + self.plans_manager.plans_name + "__" + configuration) \
            if RetUNet_results is not None else None
        ...
        self.folder_with_segs_from_previous_stage = \
            join(RetUNet_results, self.plans_manager.dataset_name,
    ...
    def build_network_architecture(architecture_class_name: str,
                                   ...
                                   patch_size:Union[int, Tuple[int, ...]]=None) -> nn.Module:
        """
            ...
            for i, k in enumerate(dataset_val.keys()):
                ...
                if next_stages is not None:
                    for n in next_stages:
                        ...
                        expected_preprocessed_folder = join(RetUNet_preprocessed, self.plans_manager.dataset_name,
