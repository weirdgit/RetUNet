...
class ResidualEncoder(nn.Module):
    def __init__(self,
        ...
        chunkwise_recurrent = (True, True, True, False)
        self.num_layers = 4
        for index in range(self.num_layers):
            dim = features_per_stage[n_stages + index - 4]
            ...
            RetLayers_reverse.append(BasicLayer(embed_dim=embed_dims[index],
                                                ...
                                                chunkwise_recurrent=chunkwise_recurrent[index],
                                                ffn_dim=3 * input_channels,
                                                drop_path=0.3))
    ...
    def forward(self, x):
        ...
        for i,s in enumerate(self.stages):
            ...
            if n - 4 < i < n:
                x = self.reverse_ret_layers[i - (n - 4)](x)
