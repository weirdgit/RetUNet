...
from retunet.inference.data_iterators import PreprocessAdapterFromNpy, preprocessing_iterator_fromfiles, \
    preprocessing_iterator_fromnpy
from retunet.inference.export_prediction import export_prediction_from_logits, \
    convert_predicted_logits_to_segmentation_with_correct_shape
from retunet.inference.sliding_window_prediction import compute_gaussian, \
    compute_steps_for_sliding_window
from retunet.utilities.file_path_utilities import get_output_folder, check_workers_alive_and_busy
...
from retunet.utilities.label_handling.label_handling import determine_num_input_channels
from retunet.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
from retunet.utilities.utils import create_lists_from_splitted_dataset_folder
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        trainer_class = recursive_find_python_class(join(retunet.__path__[0], "training", "nnUNetTrainer"),
                                                    trainer_name, 'retunet.training.nnUNetTrainer')
...
if __name__ == '__main__':
    ...
    from retunet.paths import RetUNet_results, RetUNet_raw
    ...
    predictor.initialize_from_trained_model_folder(
        join(RetUNet_results, 'Dataset003_Liver/nnUNetTrainer__nnUNetPlans__3d_lowres'),
        use_folds=(0,),
        checkpoint_name='checkpoint_final.pth',
    )
    predictor.predict_from_files(join(RetUNet_raw, 'Dataset003_Liver/imagesTs'),
                                 join(RetUNet_raw, 'Dataset003_Liver/imagesTs_predlowres'),
    ...
    img, props = SimpleITKIO().read_images([join(RetUNet_raw, 'Dataset003_Liver/imagesTr/liver_63_0000.nii.gz')])
