if __name__ == '__main__':
    ...
    indir = join(RetUNet_raw, 'Dataset003_Liver/imagesTs')
    outdir = join(RetUNet_raw, 'Dataset003_Liver/imagesTs_predlowres')
    ...
    img, props = SimpleITKIO().read_images([join(RetUNet_raw, 'Dataset003_Liver/imagesTs/liver_147_0000.nii.gz')])
    img2, props2 = SimpleITKIO().read_images([join(RetUNet_raw, 'Dataset003_Liver/imagesTs/liver_146_0000.nii.gz')])
    img3, props3 = SimpleITKIO().read_images([join(RetUNet_raw, 'Dataset003_Liver/imagesTs/liver_145_0000.nii.gz')])
    img4, props4 = SimpleITKIO().read_images([join(RetUNet_raw, 'Dataset003_Liver/imagesTs/liver_144_0000.nii.gz')])
