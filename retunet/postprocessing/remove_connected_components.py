...
from retunet.evaluation.evaluate_predictions import region_or_label_to_mask, compute_metrics_on_folder, \
    load_summary_json, label_or_region_to_key
from retunet.imageio.base_reader_writer import BaseReaderWriter
from retunet.paths import RetUNet_raw
from retunet.utilities.file_path_utilities import folds_tuple_to_string
...
if __name__ == '__main__':
    ...
    labelstr = join(RetUNet_raw, 'Dataset004_Hippocampus', 'labelsTr')
