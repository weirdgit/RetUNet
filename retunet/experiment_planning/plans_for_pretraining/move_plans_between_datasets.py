...
from retunet.utilities.file_path_utilities import maybe_convert_to_dataset_name
...
def move_plans_between_datasets(
    ...
    source_folder = join(RetUNet_preprocessed, source_dataset_name)
    ...
    target_raw_data_dir = join(RetUNet_raw, target_dataset_name)
    ...
    save_json(source_plans, join(RetUNet_preprocessed, target_dataset_name, target_plans_identifier + '.json'),
              sort_keys=False)
