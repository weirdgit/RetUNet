...
from retunet.run.load_pretrained_weights import load_pretrained_weights
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    nnunet_trainer = recursive_find_python_class(join(retunet.__path__[0], "training", "nnUNetTrainer"),
    ...
    if nnunet_trainer is None:
        raise RuntimeError(f'Could not find requested nnunet trainer {trainer_name} in '
                           f'retunet.training.nnUNetTrainer ('
                           f'{join(retunet.__path__[0], "training", "nnUNetTrainer")}). If it is located somewhere '
    ...
    preprocessed_dataset_folder_base = join(RetUNet_preprocessed, maybe_convert_to_dataset_name(dataset_name_or_id))
